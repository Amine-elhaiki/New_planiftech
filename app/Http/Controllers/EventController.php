...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('heure_debut') && $request->filled('heure_fin')) {
            $validatedData['date_debut'] = $validatedData['date_debut'] . ' ' . $request->input('heure_debut') . ':00';
            $validatedData['date_fin'] = $validatedData['date_debut'] . ' ' . $request->input('heure_fin') . ':00';
        }
